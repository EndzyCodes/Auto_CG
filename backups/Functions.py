...
def pick_challenge(debug=False):
    ...
    while 1:
        if find_image_within_window(boxer_giant_challenge_img):
            setlog("Found a undoable challenge - 'boxer giant punch up'", "warning")
            setlog("removing it now...", "info")
            click_random_within_image(check_image_presence(boxer_giant_challenge_img))
        ...
        if find_image_within_window(riding_gliding_img):
            setlog("Found a undoable challenge - 'riding n gliding'", "warning")
            setlog("removing it now...", "info")
            click_random_within_image(check_image_presence(riding_gliding_img))
        ...
        if find_image_within_window(bomber_blow_em_up_img):
            setlog("Found a undoable challenge -' bomber blow em up'", "warning")
            setlog("removing it now...", "info")
            click_random_within_image(check_image_presence(bomber_blow_em_up_img))
        ...
        if find_image_within_window(bb_challenge):
            if click_random_within_image(check_image_presence(bb_challenge, confidence=0.9)):
                ...
                time.sleep(1)
                if click_random_within_image(check_image_presence(start_btn_img, confidence=0.8)):
